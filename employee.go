...
type employeeAPIObject struct {
	...
	Age                     string  `json:"age"`                     // The employee's age. To change age, update dateOfBirth field.
	...
	HomeEmail               string  `json:"homeEmail"`               //	The employee's home email address.
	HomePhone               string  `json:"homePhone"`               //	The employee's home phone number.
	ID                      string  `json:"id"`                      //	The employee ID automatically assigned by BambooHR. Read only.
	...
	PayGroupID              int     `json:"payGroupId"`              //	The ID value corresponding to the pay group that an employee belongs to.
	...
	PayScheduleID           int     `json:"payScheduleId"`           //	The ID value corresponding to the pay schedule that an employee belongs to.
	...
	IncludeInPayroll        bool    `json:"includeInPayroll"`        //	Should employee be included in payroll (Yes or No)
	TimeTrackingEnabled     bool    `json:"timeTrackingEnabled"`     //	Should time tracking be enabled for the employee (Yes or No)
	...
	SupervisorID            int     `json:"supervisorId"`            //	The 'employeeNumber' of the employee's CURRENT supervisor. Read only.
	SupervisorEId           int     `json:"supervisorEId"`           //	The ID of the employee's CURRENT supervisor. Read only.
	...
	IsPhotoUploaded         bool    `json:"isPhotoUploaded"`         //	Whether a photo has been uploaded for the employee. Read only.
	...
	StandardHoursPerWeek    int     `json:"standardHoursPerWeek"`    //	The number of hours the employee works in a standard week.
	BonusDate               string  `json:"bonusDate"`               //	The date of the last bonus.
	BonusAmount             float32 `json:"bonusAmount"`             // The amount of the most recent bonus.
	...
	CommissionAmount        float32 `json:"commissionAmount"`        //	The amount of the most recent commission.
...
func NewEmployeeFromJSON(data []byte) (employeeAPIObject, error) {
	var employee employeeAPIObject
